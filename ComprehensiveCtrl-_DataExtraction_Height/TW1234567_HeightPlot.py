...
def plot_height_profile(tw2_no_ctrl_df: pd.DataFrame, tw1_no_ctrl_df: pd.DataFrame, tw3_pfr_ctrl_df: pd.DataFrame, tw4_qpf_ctrl_df: pd.DataFrame, tw5_tlp_ctrl_df: pd.DataFrame, tw6_tfr_ctrl_df: pd.DataFrame, tw7_w_lp_ctrl_df: pd.DataFrame) -> None:
    ...
    ax_zoom.axhline(y=52.40, color="blue", linestyle="--", linewidth=1.3, alpha=0.8)
    ax_zoom.axhline(y=50.40, color="blue", linestyle="--", linewidth=1.3, alpha=0.8)
    ...
    ax.axhline(y=52.40, color="blue", linestyle="--", linewidth=1.5, alpha=0.8, label="Target Upper Limit (52.40 mm)")
    ax.axhline(y=50.40, color="blue", linestyle="--", linewidth=1.5, alpha=0.8, label="Target Lower Limit (50.40 mm)")
...
def main() -> None:
    ...
    plot_height_profile(tw2_no_ctrl_df, tw1_no_ctrl_df, tw3_pfr_ctrl_df, tw4_qpf_ctrl_df, tw5_tlp_ctrl_df, tw6_tfr_ctrl_df, tw7_w_lp_ctrl_df)
