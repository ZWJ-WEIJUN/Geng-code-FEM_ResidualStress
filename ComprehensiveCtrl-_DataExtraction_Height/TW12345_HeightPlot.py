...
def plot_height_profile(tw2_no_ctrl_df: pd.DataFrame, tw1_no_ctrl_df: pd.DataFrame, tw3_pfr_ctrl_df: pd.DataFrame, tw4_qpf_ctrl_df: pd.DataFrame, tw5_tlp_ctrl_df: pd.DataFrame) -> None:
...
def main() -> None:
    ...
    plot_height_profile(tw2_no_ctrl_df, tw1_no_ctrl_df, tw3_pfr_ctrl_df, tw4_qpf_ctrl_df, tw5_tlp_ctrl_df)
