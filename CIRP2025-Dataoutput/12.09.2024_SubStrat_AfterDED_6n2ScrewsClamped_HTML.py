...
def plot_3d_data(datasets, title):
    ...
    pio.write_html(fig, "/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/build/CIRP2025-Dataoutput/3d_plot.html")
...
datasets = [
    (Surface_6ScrewsClamped_processed, 'darkorange', 'o', 'Before DED - 6 Screws Clamped', 10, 0.5),
    (Surface_2ScrewsClamped_processed, 'darkorange', 's', 'Before DED - 2 Screws Clamped', 10, 1.0),

    
    (Surface_6ScrewsClamped_AfterDED_processed, 'Blue', 'o', 'After DED - 6 Screws Clamped', 10, 0.5),
    (Surface_2ScrewsClamped_AfterDED_processed, 'blue', 's', 'After DED - 2 Screws Clamped', 10, 1.0),
