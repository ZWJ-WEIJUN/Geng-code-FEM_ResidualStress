...
def plot_graph(dataframes, mid_x_values, colors, markers, alphas, labels):
    ...
    plt.tight_layout()
    fig.savefig('/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/CompCtrl_DataExtraction_Width/Created_Figures/TW_SideProfile_NoCtrl_Comparison.pdf', bbox_inches='tight')
