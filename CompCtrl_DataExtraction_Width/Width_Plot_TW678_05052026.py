...
def plot_graph(dataframes, mid_x_values, colors, markers, alphas, labels):
    ...
    plt.tight_layout()
    fig.savefig('/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/CompCtrl_DataExtraction_Width/Created_Figures/TW678_SideProfile_Comparison.pdf', bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    tw_configs = [
        ...
        ('TW7 - Compr. W-LP Ctrl', 'WP6_#1_CMM_Cam_B40', 'red', 'o', 0.7),
    ...
    plt.tight_layout()
    fig2.savefig('/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/CompCtrl_DataExtraction_Width/Created_Figures/TW678_Width_Scatter.pdf', bbox_inches='tight')
    ...
    plt.tight_layout()
    fig3.savefig('/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/CompCtrl_DataExtraction_Width/Created_Figures/TW678_Width_Line.pdf', bbox_inches='tight')
