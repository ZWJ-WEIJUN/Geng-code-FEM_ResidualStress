...
#**************************Scatter Plot***************************************************     
    ...
    PFR_Height_Energy_LP_Modified = ax.scatter(Height_info,PFR_Height_Energy_LP_Modified_width, color=color_pfr_height_energy_lp_modified, label='TW 80 Comp. LP Ctrl')
    ...
    Comp_W_FR_Ctrl = ax.scatter(Height_info,Comp_W_FR_Ctrl_width, color=color_comp_w_fr_ctrl, label='TW 80 Comp. W-FR Ctrl')
    Comp_W_Energy_Ctrl = ax.scatter(Height_info,Comp_W_Energy_Ctrl_width, color=color_comp_w_energy_ctrl, label='TW 80 Comp. W-Energy Ctrl')
 ...
 #*************************Line in section Plot TW 25 Comparison***************************************************    
    ...
    for i in range(0,len(Height_target)): 
        ...
        PFR_Height_Energy_LP_Modified = ax.plot(Height_info[i*y_range:(i+1)*y_range],PFR_Height_Energy_LP_Modified_width[i*y_range:(i+1)*y_range], color=color_pfr_height_energy_lp_modified, label='Comp. LP Ctrl',linewidth=3, marker='.', markersize=17, linestyle='-')
        ...
        Comp_W_FR_Ctrl = ax.plot(Height_info[i*y_range:(i+1)*y_range],Comp_W_FR_Ctrl_width[i*y_range:(i+1)*y_range], color=color_comp_w_fr_ctrl, label='Comp. W-FR Ctrl',linewidth=3, marker='.', markersize=17, linestyle='-')
        Comp_W_Energy_Ctrl = ax.plot(Height_info[i*y_range:(i+1)*y_range],Comp_W_Energy_Ctrl_width[i*y_range:(i+1)*y_range], color=color_comp_w_energy_ctrl, label='Comp. W-Energy Ctrl',linewidth=3, marker='.', markersize=17, linestyle='-')
...
#*************************Plot section Plot***************************************************   
    ...
    ax.scatter(PFR_Height_Energy_LP_Modified_df[0]-(PFR_Height_Energy_LP_Modified_mid_x-PFR_Ctrl_mid_x), PFR_Height_Energy_LP_Modified_df[1],color=color_pfr_height_energy_lp_modified,s=5 ,  marker='.',label='Comp. LP Ctrl' )
    ...
    ax.scatter(Comp_W_FR_Ctrl_df[0]-(Comp_W_FR_Ctrl_mid_x-PFR_Ctrl_mid_x), Comp_W_FR_Ctrl_df[1],color=color_comp_w_fr_ctrl,s=5 ,  marker='.',label='Comp. W-FR Ctrl' )
    ax.scatter(Comp_W_Energy_Ctrl_df[0]-(Comp_W_Energy_Ctrl_mid_x-PFR_Ctrl_mid_x), Comp_W_Energy_Ctrl_df[1],color=color_comp_w_energy_ctrl,s=5 ,  marker='.',label='Comp. W-Energy Ctrl' )
