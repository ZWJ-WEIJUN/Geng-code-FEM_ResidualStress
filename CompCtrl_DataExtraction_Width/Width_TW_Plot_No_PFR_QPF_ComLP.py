...
if __name__ == '__main__':
    ...
    color_nc = 'black'
    color_pfr_height_energy_lp = 'indianred'
    ...
    # print('PFR Height Energy(LP) 1200 Mean:', PFR_Height_Energy_LP_mean)
    # print('PFR Height Energy(LP) 1200 SD:', PFR_Height_Energy_LP_SD)
...
# %% **********************Comparison    
    ...
    # dataframes = [No_Ctrl_df, PFR_Ctrl_df, PFR_Height_Ctrl_df, PFR_Height_Energy_LP_df, PFR_Height_Energy_LP_Modified_df, PFR_Height_Energy_LP_1223degC_df]
    # mid_x_values = [No_Ctrl_mid_x, PFR_Ctrl_mid_x, PFR_Height_Ctrl_mid_x, PFR_Height_Energy_LP_mid_x, PFR_Height_Energy_LP_Modified_mid_x, PFR_Height_Energy_LP_1223degC_mid_x]
    # colors = [color_nc, color_pfr, color_pfr_height, color_pfr_height_energy_lp, color_pfr_height_energy_lp_modified, color_pfr_height_energy_lp_1223_1]
    # labels = ['No Control', 'PFR Ctrl', 'PFR Height Ctrl', 'PFR Height Energy(LP)', 'PFR Height Energy(LP) Modified', 'PFR Height Energy(LP) 1223degC']
