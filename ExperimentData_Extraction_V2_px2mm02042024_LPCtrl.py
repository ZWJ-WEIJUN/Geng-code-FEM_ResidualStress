...
indices = np.arange(Frame_history[1:].shape[0]) # the shape of the Frame_history is (2739, 288, 382), mathes the shpae of OPCUA_read_time array.   # Frame_history[1:] - Exclude the first frame with all zero pixels because the first frame is the initilized frame with all zero pixels
