...
lns3 = ax2.plot(layer, Medium_temperature_OriginalRectSearch, linewidth=3, marker='.', markersize=10, linestyle='-', color=color_T,label='Median Temperature - FR Control')
...
# Print Medium_temperature_OriginalRectSearch
print(f"The Medium_temperature_OriginalRectSearch for FR control strategy is: {Medium_temperature_OriginalRectSearch}")
# Print the fr_array
print(f"The fr_array is: {fr_array[1:]*60}")
...
plt.legend(lns, labs, loc='lower right', fontsize=17,bbox_to_anchor=(1.0, 0.0))
