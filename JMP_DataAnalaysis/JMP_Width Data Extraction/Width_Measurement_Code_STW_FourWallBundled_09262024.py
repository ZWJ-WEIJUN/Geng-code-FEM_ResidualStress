...
if __name__ == '__main__':
    ...
    # file_path = 'C:/Users/muqin/OneDrive/Desktop/Jourmal/Width_Data_Analysis/STW_4xThicknessProfile(H,FR,LP,No).csv'
    # file_path = 'D:/Expriment_Data_Extraction/Width_Data_Analysis/Width_Data_Analysis/STW_4xThicknessProfile(H,FR,LP,No).csv'
...
#*************************Line Plot*************************************************** 
 ...
 #*************************Line in section Plot STW 70 Comparison***************************************************    
    ...
    plt.legend(by_label.values(), by_label.keys(),scatterpoints=1,loc='lower center',ncol=2,fontsize=23.5,markerscale = 1.0)
    ...
    secax.tick_params(axis='both', labelcolor='black', labelsize=30, width=2)
...
#*************************Plot section Plot***************************************************   
    ...
    ax.tick_params(axis='both', labelcolor='black',labelsize=30)
    plt.xlabel('Width-X coordinate (mm)', fontweight="bold",size=30)
