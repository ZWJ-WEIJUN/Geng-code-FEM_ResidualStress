...
if __name__ == '__main__':
    ...
    file_path_LP_FR = '/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/JMP_DataAnalaysis/STW70_LP_and_FR_Ctrl_Spline.csv'
    file_path_Comb_1 = '/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/JMP_DataAnalaysis/Combined_I_1100_and_1200.csv'
    file_path_Comb_2 = '/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/JMP_DataAnalaysis/Combine_II_1200.csv'
    file_path_LP_FR_1100 = '/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/JMP_DataAnalaysis/STW70_LP_and_FR_Ctrl_1100.csv'
    ...
    STW70_LP, STW70_FR = clean_data_v1_width(file_path_LP_FR, expected_number_of_fields)
    Combined_I_1100, Combined_I_1200 = clean_data_v3_width(file_path_Comb_1, expected_number_of_fields)    
    Combined_II_1200= clean_data_v2_width(file_path_Comb_2, expected_number_of_fields)
    STW70_LP_1100, STW70_FR_1100= clean_data_v1_width(file_path_LP_FR_1100, expected_number_of_fields)
...
#**************************Scatter Plot***************************************************     
    ...
    print("No_Ctrl_width:", No_Ctrl_width)
    print("LP_width:", LP_width)
    print("FR_width:", FR_width)
    print("Combined_II_1200_width:", Combined_II_1200_width)

    # Calculate and print the average and standard deviation for each array
    print("No_Ctrl_width - Mean:", np.mean(No_Ctrl_width), "SD:", np.std(No_Ctrl_width))
    print("LP_width - Mean:", np.mean(LP_width), "SD:", np.std(LP_width))
    print("FR_width - Mean:", np.mean(FR_width), "SD:", np.std(FR_width))
    print("Combined_II_1200_width - Mean:", np.mean(Combined_II_1200_width), "SD:", np.std(Combined_II_1200_width))
...
#*************************Plot section Plot***************************************************   
    ...
    plt.title('Step Thin Wall Side Profile',fontname="Times New Roman",
              size=17, fontweight="bold")
    ax.tick_params(axis='both', labelcolor='black',labelsize=17)
    plt.xlabel('Width-X (mm)', fontweight="bold",size=17)
