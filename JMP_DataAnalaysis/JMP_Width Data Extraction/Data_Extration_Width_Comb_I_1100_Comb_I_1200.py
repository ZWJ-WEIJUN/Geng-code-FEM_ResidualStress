...
if __name__ == '__main__':
    ...
    file_path = 'D:/Expriment_Data_Extraction/Width_Data_Analysis/Width_Data_Analysis/Combined_I_1100_and_1200.csv'
    expected_number_of_fields = 3
    Combined_I_1100, Combined_I_1200 = clean_data(file_path, expected_number_of_fields)
    
  
    
    Combined_I_1100_width,Height_info, Combined_I_1100_mean, Combined_I_1100_SD = width_cal( Combined_I_1100,Height_target,y_range,y_inc)

    print('Combined_I_1100_Mean:', Combined_I_1100_mean)
    print('Combined_I_1100_SD:', Combined_I_1100_SD)
    fig2, ax2 = plt.subplots()
    ax2.scatter(Height_info, Combined_I_1100_width)
    plt.title('STW75 Combined I Control:1100 Obj')
    plt.xlabel('Height')
    plt.ylabel('Width')
    
    
    Combined_I_1200_width,Height_info,Combined_I_1200_mean,Combined_I_1200_SD = width_cal(Combined_I_1200,Height_target,y_range,y_inc)
    print('Combined_I_1200_Mean:',Combined_I_1200_mean)
    print('Combined_I_1200_SD:',Combined_I_1200_SD)
    plt.title('STW75 Combined I Control:1200 Obj')
    fig3, ax3 = plt.subplots()
    ax3.scatter(Height_info,Combined_I_1200_width)
