...
if __name__ == '__main__':
    ...
    file_path = 'C:/Users/muqin/OneDrive/Desktop/Reasearch/Width_Data_Analysis/Width_Data_Analysis/Combine_II_1200.csv'
    expected_number_of_fields = 3
    Combined_II_1200= clean_data(file_path, expected_number_of_fields)
    
  
    
    Combined_II_1200_width,Height_info, Combined_II_1200_mean, Combined_II_1200_SD = width_cal( Combined_II_1200,Height_target,y_range,y_inc)

    print('Combined_II_1200_Mean:', Combined_II_1200_mean)
    print('Combined_II_1200_SD:', Combined_II_1200_SD)
    fig2, ax2 = plt.subplots()
    ax2.scatter(Height_info, Combined_II_1200_width)
    plt.title('STW75 Combined II Control')
    plt.xlabel('Height')
    plt.ylabel('Width')
