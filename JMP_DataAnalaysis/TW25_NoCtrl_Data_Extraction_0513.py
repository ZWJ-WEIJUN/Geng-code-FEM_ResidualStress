...
with open('TW25_No_Ctrl_run_T220240512.npy', 'rb') as f:
...
Medium_temperature_OriginalRectSearch_0510 = np.median(MaxT_OriginRectSearch_alllayers_0510, axis=1)   # Median temperature for each layer based on the rectangular (31column x 7row) search method  
...
print(f"The median temperature for each layer based on the rectangular (31column x 5row) search method - TW25-NoCtrl is: {Medium_temperature_OriginalRectSearch}")
print(f"The shape of the array of TW25-NoCtrl is: {Medium_temperature_OriginalRectSearch.shape}")
...
Medium_temperature_RecSearch31x5 = np.load('/Users/zhangweijun/Documents/GitHub/Geng-code-FEM_ResidualStress/SPTW_NOCtrl_01312024_Medium_temperature_RecSearch_5(row)x31(column).npy', allow_pickle=True)
# # Check the shape of your data
print(f'The temperature array of STW NO Ctrl is: {Medium_temperature_RecSearch31x5}')
print("Shape of temperature array of STW NO Ctrl :", Medium_temperature_RecSearch31x5.shape)
...
lns3 = ax2.plot(layer, Medium_temperature_OriginalRectSearch, linewidth=3, marker='.', markersize=10, linestyle='-', color=color_T,label='Medium Temperature - No CTRL_TW25_05122024')
...
lns4 = ax2.plot(layer, Medium_temperature_RecSearch31x5, linewidth=3, marker='.', markersize=10, linestyle='-', color='black', label ='Medium Temperature - No Ctrl_STW70')
lns5 = ax1.plot(layer, fr_array[1:], linewidth=3, marker='.', markersize=10, color=color_fr, label='Feed rate(mm/min)') 
lns6 = ax2.plot(layer, Medium_temperature_OriginalRectSearch_0510, linewidth=3, marker='.', markersize=10, linestyle='-', color='black',label='Medium Temperature - No CTRL_TW25_05102024')
...
plt.title("TW25 No Contrl:05102024", fontname="Arial Black",
