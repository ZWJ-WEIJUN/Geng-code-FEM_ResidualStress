...
def stat_cal(temp,title):
    ...
    return mid_temp_mean,mid_temp_sd,short_temp_mean,short_temp_sd
...
# %% Stat Cal
NC_mid_temp_mean,NC_mid_temp_sd, NC_short_temp_mean,NC_short_temp_sd = stat_cal(NC_Temp,'NC')
LP_mid_temp_mean,LP_mid_temp_sd, LP_short_temp_mean,LP_short_temp_sd = stat_cal(LP_Temp,'LP')
FR_mid_temp_mean,FR_mid_temp_sd, FR_short_temp_mean,FR_short_temp_sd = stat_cal(FR_Temp,'FR')
HC_mid_temp_mean,HC_mid_temp_sd, HC_short_temp_mean,HC_short_temp_sd = stat_cal(HC_Temp,'HC')
