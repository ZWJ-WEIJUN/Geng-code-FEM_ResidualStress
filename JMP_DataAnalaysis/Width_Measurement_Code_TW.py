...
#**************************Scatter Plot***************************************************     
 ...
 #*************************Line in section Plot TW 25 Comparison***************************************************    
    ...
    for i in range(0,len(Height_target)): 
        ...
        height_info_array.extend(Height_info[i*y_range:(i+1)*y_range])
    ...
    plt.legend(by_label.values(), by_label.keys(),scatterpoints=1,loc='lower left',ncol=1,fontsize=17,markerscale = 1.0)
    ...
    print("Height_info array:", height_info_array)
...
#*************************Plot section Plot***************************************************   
    ...
    ax.tick_params(axis='both', labelcolor='black',labelsize=17)
    plt.xlabel('Width-X coordiante (mm)', fontweight="bold",size=17)
