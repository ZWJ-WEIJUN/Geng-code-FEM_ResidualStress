...
with open('TW25_LP_Ctrl_run_1200_Obj20240510.npy', 'rb') as f:
...
lns3 = ax2.plot(layer, Median_temperature_OriginalRectSearch, linewidth=3, marker='.', markersize=10, linestyle='-', color=color_T,label='Median Temperature - LP CTRL_TW25_05102024')
...
plt.title("TW25 Laser Power Contrl", fontname="Arial Black",
...
# plt.show()
print(f"Size of Median_temperature_LP Ctrl: {Median_temperature_OriginalRectSearch.size}")
print(f"Median_temperature_LP Ctrl: {Median_temperature_OriginalRectSearch}")
