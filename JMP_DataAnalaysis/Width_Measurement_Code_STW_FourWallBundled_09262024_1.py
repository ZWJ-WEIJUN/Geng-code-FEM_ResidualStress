...
#*************************Line Plot*************************************************** 
 ...
 #*************************Line in section Plot STW 70 Comparison***************************************************    
    ...
    for i in range(0,len(Height_target)):    
        ...
        # Combined_II_1200_segment = Combined_II_1200_width[i*y_range:(i+1)*y_range]
        No_Ctrl_segment = np.append(No_Ctrl_segment, No_Ctrl_width[i*y_range:(i+1)*y_range])
        LP_segment = np.append(LP_segment, LP_width[i*y_range:(i+1)*y_range])
        FR_segment = np.append(FR_segment, FR_width[i*y_range:(i+1)*y_range])
        Combined_II_1200_segment = np.append(Combined_II_1200_segment, Combined_II_1200_width[i*y_range:(i+1)*y_range])  
    print(f"No_Ctrl_segment: {No_Ctrl_segment}")
    print(f"LP_segment: {LP_segment}")
    print(f"FR_segment: {FR_segment}")
    print(f"Combined_II_1200_segment: {Combined_II_1200_segment}")
    No_Ctrl_segment_16_30 = No_Ctrl_segment[16:31]
    LP_segment_16_30 = LP_segment[16:31]
    FR_segment_16_30 = FR_segment[16:31]
    Combined_II_1200_segment_16_30 = Combined_II_1200_segment[16:31]

    No_Ctrl_segment_16_30_mean = np.mean(No_Ctrl_segment_16_30)
    No_Ctrl_segment_16_30_std = np.std(No_Ctrl_segment_16_30)
    LP_segment_16_30_mean = np.mean(LP_segment_16_30)
    LP_segment_16_30_std = np.std(LP_segment_16_30)
    FR_segment_16_30_mean = np.mean(FR_segment_16_30)
    FR_segment_16_30_std = np.std(FR_segment_16_30)
    Combined_II_1200_segment_16_30_mean = np.mean(Combined_II_1200_segment_16_30)
    Combined_II_1200_segment_16_30_std = np.std(Combined_II_1200_segment_16_30)

    print('No Ctrl Segment 16-30 Mean:', No_Ctrl_segment_16_30_mean)
    print('No Ctrl Segment 16-30 Std:', No_Ctrl_segment_16_30_std)
    print('LP Segment 16-30 Mean:', LP_segment_16_30_mean)
    print('LP Segment 16-30 Std:', LP_segment_16_30_std)
    print('FR Segment 16-30 Mean:', FR_segment_16_30_mean)
    print('FR Segment 16-30 Std:', FR_segment_16_30_std)
    print('Combined II 1200 Segment 16-30 Mean:', Combined_II_1200_segment_16_30_mean)
    print('Combined II 1200 Segment 16-30 Std:', Combined_II_1200_segment_16_30_std)
    
    No_Ctrl_segment_31_45 = No_Ctrl_segment[31:46]
    LP_segment_31_45 = LP_segment[31:46]
    FR_segment_31_45 = FR_segment[31:46]
    Combined_II_1200_segment_31_45 = Combined_II_1200_segment[31:46]

    No_Ctrl_segment_31_45_mean = np.mean(No_Ctrl_segment_31_45)
    No_Ctrl_segment_31_45_std = np.std(No_Ctrl_segment_31_45)
    LP_segment_31_45_mean = np.mean(LP_segment_31_45)
    LP_segment_31_45_std = np.std(LP_segment_31_45)
    FR_segment_31_45_mean = np.mean(FR_segment_31_45)
    FR_segment_31_45_std = np.std(FR_segment_31_45)
    Combined_II_1200_segment_31_45_mean = np.mean(Combined_II_1200_segment_31_45)
    Combined_II_1200_segment_31_45_std = np.std(Combined_II_1200_segment_31_45)

    print('No Ctrl Segment 31-45 Mean:', No_Ctrl_segment_31_45_mean)
    print('No Ctrl Segment 31-45 Std:', No_Ctrl_segment_31_45_std)
    print('LP Segment 31-45 Mean:', LP_segment_31_45_mean)
    print('LP Segment 31-45 Std:', LP_segment_31_45_std)
    print('FR Segment 31-45 Mean:', FR_segment_31_45_mean)
    print('FR Segment 31-45 Std:', FR_segment_31_45_std)
    print('Combined II 1200 Segment 31-45 Mean:', Combined_II_1200_segment_31_45_mean)
    print('Combined II 1200 Segment 31-45 Std:', Combined_II_1200_segment_31_45_std)
...
#*************************Plot section Plot***************************************************   
    ...
    plt.xlabel('Width-X coordinate (mm)', fontweight="bold",size=20)
    plt.ylabel('Height-Z coordinate (mm)', fontweight="bold",size=20)
