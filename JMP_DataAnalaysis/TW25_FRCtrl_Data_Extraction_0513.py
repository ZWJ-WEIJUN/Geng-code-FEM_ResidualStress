...
with open('TW25_FR_Ctrl_run_1200_Obj20240513.npy', 'rb') as f:
...
Median_temperature_OriginalRectSearch_0510 = np.median(MaxT_OriginRectSearch_alllayers_0510, axis=1)   # Median temperature for each layer based on the rectangular (31column x 7row) search method  
...
lns3 = ax2.plot(layer, Median_temperature_OriginalRectSearch, linewidth=3, marker='.', markersize=10, linestyle='-', color=color_T,label='Median Temperature - FR CTRL_TW25_05132024')
...
print(f"Size of the median temperature of FR Ctrl for ThinWall 25mm: {Median_temperature_OriginalRectSearch.size}")
print(f"median temperature of FR Ctrl for ThinWall 25mm: {Median_temperature_OriginalRectSearch}")

print(f"Size of fr_array[1:] for ThinWall 25mm: {fr_array[1:].size}")
print(f"fr_array[1:] for ThinWall 25mm: {fr_array[1:]}")
...
plt.title("TW25 Feed Rate Contrl:05132024", fontname="Arial Black",
