...
lns3 = ax2.plot(layer, Medium_temperature_OriginalRectSearch, linewidth=3, marker='.', markersize=10, linestyle='-', color=color_T,label='Medium Temperature - No CTRL_TW25')
print(f"No Ctrl-ThinWall-Tempe: {Medium_temperature_OriginalRectSearch}")
print(f"The shape of No Ctrl-ThinWall-Tempe array is: {Medium_temperature_OriginalRectSearch.shape}")
...
lns5 = ax1.plot(layer, fr_array[1:], linewidth=3, marker='.', markersize=10, color=color_fr, label='Feed rate') 
...
plt.title("TW20 No Contrl", fontname="Arial Black",
