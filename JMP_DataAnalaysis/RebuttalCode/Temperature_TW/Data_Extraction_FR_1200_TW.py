...
plt.title("FR Control Thin Wall with 1200$^\circ$C Objective", fontname="Times New Roman",
...
lns3 = ax2.plot(layer, Medium_temperature_OriginalRectSearch, linewidth=3, marker='s', markersize=6, linestyle='-', color=color_T,label='$T_{i}$ - FR Ctrl')
