...
def Height_cal(cleanData,Extraction_Range, x_deducted):
    ...
    CI_data = np.array(df_H[1])
    lower,upper = st.norm.interval(confidence=0.95,  
                loc=np.mean(CI_data), 
                scale=st.sem(CI_data)) 
    CI = (upper-lower)/2
    print("CI:", upper, '+' , lower)
    return   df_all_height, TW_mean, TW_sd,CI
...
if __name__ == '__main__':
    ...
    file_path_NC = 'C:/Users/muqin/OneDrive/Desktop/Reasearch/Profile_Data_Analysis/Height_Data_Analysis/TW25_NoCtrl_Front_09082024.csv'
    file_path_LP = 'C:/Users/muqin/OneDrive/Desktop/Reasearch/Profile_Data_Analysis/Height_Data_Analysis/TW25_LPCtrl_Front_09082024.csv'
    file_path_FR = 'C:/Users/muqin/OneDrive/Desktop/Reasearch/Profile_Data_Analysis/Height_Data_Analysis/TW25_FRCtrl_Front_09082024.csv'
    file_path_HC = 'C:/Users/muqin/OneDrive/Desktop/Reasearch/Profile_Data_Analysis/Height_Data_Analysis/TW25_HybridCtrl_Front_09082024.csv'
    ...
    NC_df, NC_mean, NC_SD, NC_CI = Height_cal(NC,  Extraction_Range,x_deducted)
    LP_df, LP_mean, LP_SD, LP_CI = Height_cal(LP,  Extraction_Range,x_deducted)
    FR_df, FR_mean, FR_SD, FR_CI  = Height_cal(FR,  Extraction_Range,x_deducted)
    HC_df, HC_mean, HC_SD, HC_CI = Height_cal(HC,  Extraction_Range,x_deducted)
    ...
    print('CI[NC,LP,FR,HC]:', [NC_CI,LP_CI,FR_CI,HC_CI])
...
#**************************Scatter Plot***************************************************     
    ...
    # plt.ylim(2.4,3.8)
    plt.title('TW Control Method Height Comparison',fontname="Times New Roman",
