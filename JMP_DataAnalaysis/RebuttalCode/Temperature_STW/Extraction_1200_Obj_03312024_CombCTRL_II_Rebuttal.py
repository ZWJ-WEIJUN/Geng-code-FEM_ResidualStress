...
plt.title("Hybrid Control Step Thin Wall with 1200$^\circ$C Objective", fontname="Times New Roman",
...
for index, frame_index_i in enumerate(Frame_index):
    ...
    # plt.colorbar(label='Value' ,labelsize=30)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize=30)
    # Set up the title for the plot
    plt.title(f'Layer #{index+1}',fontsize=30)
